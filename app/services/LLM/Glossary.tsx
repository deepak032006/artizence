...
export default function Glossary() {
  return (
    <div className="max-w-5xl ml-90 bg-[#2E1158] text-white mt-10 p-10 md:p-12 rounded-2xl mb-32 shadow-md">
      ...
      <ul className="list-none space-y-4 text-gray-100">
        ...
        <li>Common Use Cases for LLM Applications</li>
        <li>What are general-purpose LLMs?</li>
