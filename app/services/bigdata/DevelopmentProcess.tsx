...
export default function DevelopmentProcess() {
  return (
    <div className="w-full flex justify-center px-4 sm:px-6 md:px-8">
      <main className="w-full md:w-4/5 lg:w-3/4 bg-[#3c1a88] text-white mt-10 p-7 md:p-12 rounded-2xl mb-32 shadow-md min-h-[350px]">
        ...
        <div>
          ...
          <ul className="list-disc list-inside space-y-3 text-gray-200 text-left">
            <li>
